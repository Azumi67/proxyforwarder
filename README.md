**مانیتورینگ یک پروژه شخصی بوده است و اگر میخواهید واقعا استفاده کنید باید امنیت مانیتورینگ هم برقرار شود و کمی تغییرات در کد ها بدهم اما خود فوروارد مشکلی ندارد و من مدت طولانی استفاده کردم** 
